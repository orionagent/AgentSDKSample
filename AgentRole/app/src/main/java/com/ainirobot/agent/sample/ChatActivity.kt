    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pageAgent.setOnAgentStatusChangedListener(object : OnAgentStatusChangedListener {
            override fun onStatusChanged(status: String, message: String?): Boolean {
                ...
                // 如果不想把状态显示到默认字幕条上，则返回true，如果想保留系统显示状态UI，则返回false
        ...
        //                 val userQuery = params?.getString("user_query") ?: return false
        //                 generateRoleResponse(userQuery, action)
        //                 return true
        //             }
        //         }
        //     )
